  ...
  admin: {
    ...
    accounts: {
      ...
      types: {
        ...
        windsurfOauth: 'Email & Password / Token Import',
        windsurfApikey: 'Import API Key directly',
        windsurfPassword: 'Email & Password login',
      ...
      windsurf: {
        authModeTitle: 'Windsurf Auth Method',
        apikeyDesc: 'Import Windsurf API Key directly',
        passwordTitle: 'Email & Password',
        passwordDesc: 'Login with Windsurf email and password',
        email: 'Email',
        password: 'Password',
        pleaseEnterCredentials: 'Please enter email and password',
        tokenTitle: 'Token Import',
        tokenDesc: 'Import Firebase ID Token',
        tokenLabel: 'Token',
        tokenHint: 'Get it from https://windsurf.com/show-auth-token',
        pleaseEnterToken: 'Please enter a token',
        oauthTitle: 'Browser OAuth',
        oauthDesc: 'Login via browser authorization',
        oauthInfo: 'Click the button below to open the Windsurf login page. After logging in, obtain the token and import it.',
        oauthLoading: 'Generating...',
        oauthButton: 'Open Windsurf Login Page',
        oauthUrlLabel: 'Authorization URL',
        oauthUrlHint: 'If the browser did not open automatically, copy this link and visit it manually',
      },
      anthropic: {
      ...
      oauth: {
        ...
        windsurf: {
          ...
          followSteps: 'Follow these steps to authorize your Windsurf account:',
          step1GenerateUrl: 'Generate authorization URL',
          generateAuthUrl: 'Generate Auth URL',
          step2OpenUrl: 'Open the link in your browser and log in',
          openUrlDesc: 'Open the authorization link in a new tab and log in with your Windsurf account.',
          step3EnterCode: 'Enter the callback URL or token',
          authCodeDesc: 'After authorization, the browser will redirect to http://localhost:8086/callback?access_token=... :',
          authCode: 'Callback URL or Token',
          authCodePlaceholder: 'Option 1: Paste the full callback URL\n(http://localhost:8086/callback?access_token=...)\nOption 2: Paste only the access_token value',
          authCodeHint: 'You can paste the full callback URL or just the access_token value. The system will auto-detect.'
        }
      },
      ...
      usageWindow: {
        ...
        kiroReset: 'Reset',
        kiroOverage: 'Overage',
        windsurfOverageBalance: 'Balance',
        windsurfMembershipPeriod: 'Membership',
        windsurfPlanExpired: 'Expired',
        windsurfPlanRemaining: '{days}d left',
