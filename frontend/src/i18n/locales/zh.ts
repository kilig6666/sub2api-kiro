  ...
  admin: {
    ...
    accounts: {
      ...
      types: {
        ...
        windsurfOauth: '邮箱密码 / Token 导入',
        windsurfApikey: '直接导入 API Key',
        windsurfPassword: '邮箱密码登录',
      ...
      usageWindow: {
        ...
        kiroReset: '重置',
        kiroOverage: '超额',
        windsurfOverageBalance: '余额',
        windsurfMembershipPeriod: '会员期限',
        windsurfPlanExpired: '已到期',
        windsurfPlanRemaining: '剩余{days}天',
      ...
      windsurf: {
        authModeTitle: 'Windsurf 授权方式',
        apikeyDesc: '直接导入 Windsurf API Key',
        passwordTitle: '邮箱密码',
        passwordDesc: '使用 Windsurf 邮箱密码登录',
        email: '邮箱',
        password: '密码',
        pleaseEnterCredentials: '请输入邮箱和密码',
        tokenTitle: 'Token 导入',
        tokenDesc: '导入 Firebase ID Token',
        tokenLabel: 'Token',
        tokenHint: '打开https://windsurf.com/show-auth-token获取',
        pleaseEnterToken: '请输入 Token',
        oauthTitle: '浏览器 OAuth',
        oauthDesc: '通过浏览器登录授权',
        oauthInfo: '点击下方按钮将打开 Windsurf 登录页面，完成登录后获取 Token 并导入。',
        oauthLoading: '生成中...',
        oauthButton: '打开 Windsurf 登录页面',
        oauthUrlLabel: '授权链接',
        oauthUrlHint: '如果浏览器未自动打开，请手动复制此链接到浏览器中访问',
      },
      anthropic: {
      ...
      oauth: {
        ...
        windsurf: {
          title: 'Windsurf 账号授权',
          followSteps: '请按照以下步骤完成 Windsurf 账号的授权：',
          step1GenerateUrl: '生成授权链接',
          generateAuthUrl: '生成授权链接',
          step2OpenUrl: '在浏览器中打开链接并完成登录',
          openUrlDesc: '请在新标签页中打开授权链接，使用您的 Windsurf 账号登录并授权。',
          step3EnterCode: '输入回调链接或 Token',
          authCodeDesc: '授权完成后，浏览器会跳转到 http://localhost:8086/callback?access_token=... 页面：',
          authCode: '回调链接或 Token',
          authCodePlaceholder: '方式1：复制完整的回调链接\n(http://localhost:8086/callback?access_token=...)\n方式2：仅复制 access_token 参数的值',
          authCodeHint: '您可以直接复制整个回调链接或仅复制 access_token 值，系统会自动识别'
        }
      },
